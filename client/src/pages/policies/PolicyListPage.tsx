  ...
  return (
    <div className="space-y-6 p-6">
      ...
      {isLoading ? (
        ...
        <div className="flex min-h-64 flex-col items-center justify-center rounded-xl border border-dashed border-slate-300 bg-white px-6 text-center dark:border-slate-700 dark:bg-gray-900">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <span className="mt-2 inline-flex max-w-full items-center gap-1.5 rounded-md bg-slate-100 px-2 py-1 text-xs font-medium text-gray-700 dark:bg-slate-800 dark:text-gray-300">
