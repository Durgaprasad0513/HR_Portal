        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 border border-gray-100 dark:border-gray-800 rounded-lg bg-surface/50">
                <div>
                  <p className="text-sm font-medium dark:text-gray-200">Client Dinner - NY Trip</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">Submitted by Mike Ross</p>
                </div>
              ...
              <div className="flex items-center justify-between p-3 border border-gray-100 dark:border-gray-800 rounded-lg bg-surface/50">
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">Submitted by IT Dept</p>
                </div>
                <div className="text-right">
