        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="border border-gray-100 dark:border-gray-800 rounded-lg p-4 bg-surface/50">
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 dark:text-gray-500 dark:text-gray-400 mt-2">2 hours ago</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 dark:text-gray-500 dark:text-gray-400 mt-2">1 day ago</p>
                </div>
              </div>
            </div>
          </CardContent>
